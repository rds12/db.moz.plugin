...
function import_javascript(file){
    ...
    //alert('chrome://db.moz.plugin/content/javascripts/' + file + '.js');
    loader.loadSubScript(
      'chrome://db.moz.plugin/content/javascripts/' + file + '.js'
    );
}

function import_library(file){
    try{db.moz.plugin;}catch(e){
      import_javascript('libraries/namespace.lib');
      import_javascript('libraries/console.lib');
    }
    import_javascript('libraries/'+file+'.lib');
}
